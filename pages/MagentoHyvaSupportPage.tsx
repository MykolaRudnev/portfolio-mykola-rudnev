...
export function MagentoHyvaSupportPage() {
  ...
  useEffect(() => {
    return injectJsonLd("professional-service", {
    ...
    <>
      ...
      <section className="px-6 py-16 pb-24 text-center max-w-xl mx-auto">
        ...
        <p className="text-gray-400 mb-6 text-sm max-w-lg mx-auto">
          ...
          <Link to={ROUTES.emergencySupport} className="text-cyan-400 hover:underline">
            emergency support
          </Link>
          .
        </p>
...
function HeaderCtas() {
  return (
    <div className="flex flex-wrap gap-4 justify-center">
      ...
      <CtaButton to={ROUTES.pricing} variant="secondary">
        Engagement models
      </CtaButton>
    </div>
  )
...
function motionFallbackEngagementModels() {
  return (
    <motionFallbackEngagementModelsGrid>
...
function motionFallbackEngagementModelsGrid({ children }: { children: React.ReactNode }) {
